...
**/
trigger PackageItemTrigger on Package_Item__c (after delete, after insert, after update, before delete, before insert, before update) 
{
    PackageItemTriggerHandler handler = new PackageItemTriggerHandler();
