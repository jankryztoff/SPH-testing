/*
     ...
     * History: 20/06/2016 - Fix for PD-0586 Added by Jessa Trangia
     */
    ...
    trigger SP_BatchJobSchedulerTrigger on BATCH_JOB_SCHEDULER__c (before insert) {
        ...
        //START Code Review Jean Cari̱o 2/18/2015 : check inputBatchSet if null
        ...
        //END Code Review Jean Cari̱o 2/18/2015 : check inputBatchSet if null
        /*
        ...
        //END 04/14/2015 D-2740 Kevin Evasco - Get the number of parallel jobs from custom settings
          ...
          //END D-2452 Wenjun 18/03/15
            ...
            //END UD-2847 22-Sept-2015 Added By S.Puli
                ...
                //START:D-2218 2/13/15 Added by Manolo Vale̱a - Removed as present gift is no longer needed.
                ...
                //END:D-2218 2/13/15 Added by Manolo Vale̱a
          ...
          //START:D-2218 2/13/15 Added by Manolo Vale̱a - Added new conditions for the new letter templates that will be added soon.
                //START : 20/03/2015 Added by Jean Cari̱o for MD42
         ...
         //START D-2777 Wenjun 16/04/15 : Set Delivery Subscription Active Flag
               ...
               // START : UD-683 4/17/2015 Jean Cari̱o
               ...
               // END : UD-683 4/17/2015 Jean Cari̱o           
               ...
               //End D-3235 14-July-2015 Added by Raviteja
                ...
                //Start Description: .  Create SP065 job and schedule daily till L-2. Run the job after SP057. Job parameter will be (TRUE, FALSE, BRD) Date: 20-June-2016 Added by J.M.Trangia
                else if(batchCode == 'SP065')
                {                             
                    BatchCOCP batchableInstance = new BatchCOCP(true, false, batchRundate);
                    batchRunRequest.SFDC_Job_id__c = Database.executeBatch(batchableInstance, 1000);
                }
                //End Description: .  Create SP065 job and schedule daily till L-2. Run the job after SP057. Job parameter will be (TRUE, FALSE, BRD) Date: 20-June-2016 Added by J.M.Trangia
                //Start Description: Create SP066 and schedule only on L-1 . Run the job after SP057. Job parameter will be (TRUE, TRUE, BRD) Date: 20-June-2016 Added by J.M.Trangia
               
                else if(batchCode == 'SP066')
                {                             
                    BatchCOCP batchableInstance = new BatchCOCP(true, true, batchRundate);
                    batchRunRequest.SFDC_Job_id__c = Database.executeBatch(batchableInstance, 1000);
                }
                //End Description: Create SP066 and schedule only on L-1 . Run the job after SP057. Job parameter will be (TRUE, TRUE, BRD) Date: 20-June-2016 Added by J.M.Trangia
